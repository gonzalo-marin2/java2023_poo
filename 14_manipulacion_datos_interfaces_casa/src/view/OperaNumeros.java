...
class SumaCuadrado implements UnaryOperator<Integer>{
...
public class OperaNumeros {
	...
	public static void main(String[] args) {
		...
		//Pasar el cuadrado de un número
		System.out.println("La suma de los cuadrados es: "+service.sumaTransformacion(numeros,new SumaCuadrado()));
